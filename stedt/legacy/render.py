...
\t<!-- note reconstructions arrive from render_note with their leading '*' as literal text
\t  (wrapped in an unstyled span.star), so the legacy shell needs no star rule of its own -->
\t{cog}
